...
5. To verify if the data was imported correctly, you can do a simple query statement like "SELECT * FROM NBAA LIMIT 15;" which displays the first 15 rows of the table.
